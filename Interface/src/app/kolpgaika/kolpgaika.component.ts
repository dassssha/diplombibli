...
@Component({
  selector: 'app-kolpgaika',
  templateUrl: './kolpgaika.component.html',
  styleUrls: ['./kolpgaika.component.css']
})
export class KolpgaikaComponent implements OnInit {

  searchText = '';
  name:string = 'gostskolp';
  gosts: any[];
  searchGosts: any[];
  gost: any;
  TypeGosts: any[];
  ...
  constructor(private gostsService: KolpgaikaService) { }
   ...
   async getTypeGOSTS(gost): Promise<void> {
    ...
    insertFile(TypeGost: any,typeRezb: any): void {
      ...
      setString(TypeGost,typeRezb): string {
          ...
          str = str + TypeGost.s + '/'//длина верхнего цилиндра по оси х
          str = str + TypeGost.m//расстояние многоугольника на эскизе
          str = str + '/'
          str = str + TypeGost.dw//выдавливание многоугольника
          str = str + '/'
          str = str + TypeGost.r//диаметр окружности под резьбу
          str = str + '/'
          str = str + TypeGost.h//радиус сопряжения
          str = str + '/'
          str = str + TypeGost.d//размер внешней фаски
          str = str + '/'
          str = str + TypeGost.l//размер внутренних фасок 
          str = str + '/'
          str = str + TypeGost.l1//размер внешней фаски
          str = str + '/'
          str = str + TypeGost.da//размер внешней фаски
          str = str + '/'
          str = str + typeRezb.type_rezb
          str = str + '/'
          str = str + this.gost['ispoln']//размер внешней фаски
          console.log(str)
          return str;
